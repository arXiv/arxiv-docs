...
Registered users may [submit articles](/help/submit) to be announced by arXiv. Submissions to arXiv are subject to a [moderation process](/help/moderation) that verifies material is topical to subject areas and has scholarly value. Material is not peer-reviewed by arXiv - the content of arXiv submissions are wholly the responsibility of the submitter and are presented “as is” without any warranty or guarantee. Hosting works or any materials on this site does not in any way convey tacit or implied approval of its assumptions, methods, results, or conclusions by any agent of arXiv or Cornell University (electronic, mechanical, or otherwise). 
