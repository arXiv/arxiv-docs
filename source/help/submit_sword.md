...
([contact](/help/contact.md)), at least during the initial
...
rights](/help/license/index.md) by the author or submitter to
...
Please refer to the arXiv [submission help](/help/prep.md)
...
[checking](/help/submit.md#correct).
...
[replacement](/help/replace.md) via the web interface also
apply to a replacement using SWORD. In particular a new version number
will be assigned unless it is a [same day
replacement](/help/replace.md#sameday), and all [previously
published versions](/help/replace.md#versions) remain
accessible.
...
owner](/help/authority.md) or the author of the original
...
Please [contact](/help/contact.md) arXiv with any questions
or suggestions.
