...
The following privacy notice describes the Personal Data we collect from you when you visit arXiv.org and how we use this information. For the purposes of this notice, “Personal Data” is defined as information relating to an identified or identifiable individual; an identifiable individual is one who can be identified, directly or indirectly, by use of any identifier or characteristic specific to that individual. Please read this privacy notice carefully so that you understand our privacy practices. We reserve the right to change this policy at any time to reflect changes in the law, our data collection and use practices, the features of our services, or advances in technology. Please check this page periodically for changes. Your continued use of arXiv following the posting of changes to this policy will be deemed to mean you understand the applicability of those changes.

## Types of Personal Data arXiv May Collect About You

When you use our site to access our online content, create a user account, upload material to our website, submit feedback or initiate a help request, contribute to our mission by donating to arXiv, participate in our webinars, or sign up to receive arXiv news or participate in other activities sponsored or hosted by arXiv, we collect Personal Data about you, as described below, to allow us to effectively run the arXiv service

We may collect the following information based on how you engage with arXiv:

- **Users who browse the website** – IP address, pathways navigated through the website, type of internet browser used. We do not make any attempt to identify you from the information collected; the information is stored in log files.
...
- **Donors** – name, address, email address, institutional affiliation (if provided), and financial information to enable the processing of the donation.
...
- **Scholarly paper and article submission, hosting, and archiving** – In the content submission and moderation process we link user accounts, authorship, and submitted content to track and process submissions, as follows:
    ...
    - The email address that was used to upload each submission is viewable by registered arXiv users to give users the ability to send feedback on papers to the submitter and to help users [contact eligible arXiv endorsers](../endorsement.md) in order to make their own submissions.
    - For more information, see [Submission Guidelines](../submit/index.md), [Author Registration](../registerhelp.md), [arXiv Submittal Agreement](submission_agreement.md), and [arXiv Moderation](../moderation/index.md).
- **Fraud and abuse protection** – We log requests in order to detect fraud and prevent unauthorized access, for example, from DDoS (distributed denial-of-service) attacks.
...
- **Sending email announcements** – Users who subscribe to receive daily email announcements of arXiv papers provide arXiv with their email address and full name and indicate the archive whose listings they want to receive. For more information see [Email subscriptions for new papers](../subscribe.md).
- **Fundraising** – Should you decide to donate to arXiv through the Donate page, you will be asked for information to process your donation, and you may receive fundraising emails, from which you can unsubscribe at any time.
...
arXiv may gather information to track user trends and site usage with the goal of improving our website users’ experience, optimizing the website, and for scientific research in the public interest. We also use the information to administer the website and prevent abuse.

Cookies and Browser Local Storage – Like most other website operators, we may use cookies, browser local storage, and similar technologies to operate the site, remember your preferences, prevent abuse, and, where you have opted in, to collect data for scientific research. Cookies are small text files stored on your computer and accessible only to the websites that create them. Local storage is a browser-based technology that allows websites to store data locally on your device to support functionality such as saving preferences. Your browser will store information related to these technologies locally on your device.  If you switch browsers, or use a different computer, neither your cookies nor local storage data will follow you. Some cookies and local data are optional and are used for nonessential functionality, others are essential to the proper functioning of the arXiv site. When arXiv.org stores Personal Data in a cookie or local storage, that data may persist for up to one year, unless cleared by you. 

Essential cookies are used to store your user identification and session authentication information when you log in to your arXiv account. arXiv or its hosting providers may use essential cookies or browser local storage related to load balancing, content delivery, and session management. If you are presented with the option to accept or decline a nonessential feature, a cookie or browser local storage may be used to store your choice.

arXiv uses nonessential cookies or browser local storage to save any preferences you select for your use of arXiv. This includes, but may not be limited to:

- That you have dismissed a banner we have shown you.
- The Labs integrations you choose to see on each abstract page.
...
- Opting in to data collection for research in the public interest.

We do not use cookies to track your use of arXiv, except in cases where users proactively opt in to allow tracking cookies to collect data for research in the public interest.  We will only place these cookies on your device if you provide your explicit consent.  You may withdraw this consent at any time on the [arXiv research opt in page](https://arxiv.org/research-opt-in/).  Personal Data collected for use in research will be completely anonymized or deleted by arXiv after five years. 

It is not necessary to use/permit cookies to read articles on arXiv.org.  Most web browsers are set to accept cookies by default. If you prefer, you can go to your browser settings to learn how to delete or reject cookies. If you choose to delete or reject cookies, this could affect certain features of our services. As a reminder, logging in to your arXiv account or setting preferences on arXiv.org requires cookies. Deletion of essential cookies may affect arXiv’s ability to remember or implement your requests, including in connection with Personal Data.
...
**External websites** – From time to time, we will link to external websites that we neither own nor control. arXiv is not responsible for the content, privacy practices, or web accessibility needs on these websites.
...
**Researchers** – In such cases, your information will be handled and processed only by persons who are responsible for the necessary activities for the research study, which may include arXiv, its employees, and its volunteers; external research collaborators unaffiliated with arXiv; and funding agencies and research sponsors.

**Legal and contract enforcement** – We may disclose your Personal Data to legal or government regulatory authorities as required by applicable law. We may also disclose your Personal Data to third parties in connection with claims, disputes, or litigation, or when we believe, in good faith, that such release is reasonably necessary to:

- Comply with applicable law;
- Enforce or apply the terms of any of our user agreements;
- Protect the rights, property, or safety and security of arXiv, our users, or others; or
- Enforce our legal rights or contractual commitments that you have made.

**Public** – Users with registered arXiv accounts can view the email address that was used to upload each submission to arXiv. Please see the [email protection page](../email-protection.md) for more information.
...
**Fundraising emails** – Donors to arXiv may receive fundraising emails. Those emails contain a link at the bottom of the email to unsubscribe.
...
**Withdraw consent for previously agreed to cookies** – Users who have opted in to arXiv functionality that is dependent on cookes can opt out of these cookies at any time by modifying the settings in their web browser. Users who have opted into data collection for research in the public interest can opt out at any time on the [arXiv research opt in page](https://arxiv.org/research-opt-in/).
...
The bases arXiv relies on for processing your Personal Data are set forth below. Please note that we may process your Personal Data on more than one legal basis, depending on the specific purpose for which we are using each element of data.

- **Legitimate interest** – We have a legitimate interest in processing Personal Data contained in article submissions, and of site visitors and submitters, to carry out our archiving, research and educational mission, vision, and values; provide you with core archival, research and educational services in the public interest, including the dissemination of, and open access to, scholarly articles in specific fields of research; implement our policies and procedures; and meet our community’s expectations. We also have legitimate interests in processing your Personal Data for providing access to our site, testing and improving site functionality and user experiences on our site, providing user support, maintaining safety and security on our site, and engaging with donors and members.  We also process Personal Data where necessary to protect the rights, property, or safety and security of arXiv, our users, or others, and to establish, exercise, or defend legal claims and enforce any terms of use to which you have agreed.
- **Contract** – We need your Personal Data to provide you with our services, respond to your inquiries, and to perform any agreement with you.
...
If you wish to exercise your rights or have other questions or concerns related to your rights under Relevant Law, please fill out a Privacy Data Subject Rights Request. To avoid taking action regarding your Personal Data at the direction of someone other than you, we may ask you for information verifying your identity.
...
If you have any complaints regarding our privacy practices, please contact [arXiv User Support](https://arxiv.org/support). If you are not satisfied with our response, you also may be able to make a complaint to your national data protection authority, supervisory authority, or other legal authority to the extent such authority has jurisdiction over the processing at issue.
