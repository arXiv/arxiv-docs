...
There are a significant number of TeX Live changes since arXiv's last release update. 
...
**If you are submitting older source for a new article, 
that was developed using an older TeX Live release,
it is very important to review the PDF generated by TL2023.**

Below we detail some of the issues encountered.
...
biblatex
    The error is caused by changes in LaTeX definitions. The issue has been 
resolved in biblatex version v3.18b and above. 
...
Glossaries: 
    ...
    Cause:
        ...
        From CHANGES as of v4.50 (2022-10-14):
            http://ctan.math.utah.edu/ctan/tex-archive/macros/latex/contrib/glossaries/CHANGES
