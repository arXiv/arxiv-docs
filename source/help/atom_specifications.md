...
```
**&lt;published&gt;**
Announcement date for the update on the article. For new papers this is the date the paper was officially announced on arXiv, for all others it’s the date of the official announcement of the update.  
```
