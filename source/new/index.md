...
A new "Quantitative Biology" archive, q-bio@arXiv.org, has been opened up for submissions. For more info, see this [announcement](/new/q-bio_announce.md). It is partitioned into [10 subject classes](/new/q-bio_announce.md) and e-mail subscriptions can be made to any combination of subject classes. It has been "preseeded" with roughly 2000 relevant cross-listings from existing subject areas.
