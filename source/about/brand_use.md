...
2. If use is allowed, display of the arXiv logo should always follow the visual layout rules as stated in the [arXiv brand guide](brand.md). 
...
3. Use of arXiv’s logo must follow our [visual brand guidelines](brand.md).
