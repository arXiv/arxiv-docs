...
**[CC - Computational Complexity](https://arxiv.org/list/cs.CC/recent)** - Christopher Umans

Covers models of computation, complexity classes, structural complexity, complexity tradeoffs, upper and lower bounds. Roughly includes material in ACM Subject Classes F.1 (computation by abstract devices), F.2.3 (tradeoffs among complexity measures), and F.4.3 (formal languages), although some material in formal languages may be more appropriate for Logic in Computer Science. Some material in F.2.1 and F.2.2, may also be appropriate here, but is more likely to have Data Structures and Algorithms as the primary subject area.

**[CG - Computational Geometry](https://arxiv.org/list/cs.CG/recent)** - Kevin Buchin, Jeff Erickson

Roughly includes material in ACM Subject Classes I.3.5 and F.2.2.

**[CE - Computational Engineering, Finance, and Science](https://arxiv.org/list/cs.CE/recent)** - Paolo Bientinesi
...
**[CL - Computation and Language (Computational Linguistics and Natural Language and Speech Processing)](https://arxiv.org/list/cs.CL/recent)** (_subsumes cmp-lg_) - Stuart Shieber

Covers natural language processing. Roughly includes material in ACM Subject Class I.2.7. **Note that work on artificial languages (programming languages, logics, formal systems) that does not explicitly address natural-language issues broadly construed (natural-language processing, computational linguistics, speech, text retrieval, etc.) is not appropriate for this area.**

**[CV - Computer Vision and Pattern Recognition](https://arxiv.org/list/cs.CV/recent)** - David Forsyth
...
**[CY - Computers and Society](https://arxiv.org/list/cs.CY/recent)** - Aylin Caliskan
...
**[CR - Cryptography and Security](https://arxiv.org/list/cs.CR/recent)** - Jeremiah Blocki
...
**[DB - Databases](https://arxiv.org/list/cs.DB/recent)** - H.V. Jagadish
...
**[DS - Data Structures and Algorithms](https://arxiv.org/list/cs.DS/recent)** - David Eppstein
...
**[DL - Digital Libraries](https://arxiv.org/list/cs.DL/recent)** - Michael Lesk
...
**[DM - Discrete Mathematics](https://arxiv.org/list/cs.DM/recent)** - Jeff Erickson, Marcin Pilipczuk
...
**[DC - Distributed, Parallel, and Cluster Computing](https://arxiv.org/list/cs.DC/recent)** - Shlomi Dolev
...
**[ET - Emerging Technologies](https://arxiv.org/list/cs.ET/recent)** - Igor Markov, Dmitri Maslov
...
**[FL - Formal Languages and Automata Theory](https://arxiv.org/list/cs.FL/recent)** - Michael Domaratzki
...
**[GT - Computer Science and Game Theory](https://arxiv.org/list/cs.GT/recent)** - Michal Feldman, David Parkes, Moshe Tennenholtz
...
**[GL - General Literature](https://arxiv.org/list/cs.GL/recent)** - Joe Halpern
...
**[GR - Graphics](https://arxiv.org/list/cs.GR/recent)** - Stephen Spencer and David Salesin
...
**[AR - Hardware Architecture](https://arxiv.org/list/cs.AR/recent)** - Onur Mutlu

Covers systems organization and architecture. Roughly includes material in ACM Subject Classes C.0, C.1, and C.5.

**[HC - Human-Computer Interaction](https://arxiv.org/list/cs.HC/recent)** - Terry Winograd and Michael Bernstein
...
**[IR - Information Retrieval](https://arxiv.org/list/cs.IR/recent)** - James Allan
...
**[IT - Information Theory](https://arxiv.org/list/cs.IT/recent)** - Venkat Guruswami and Muriel Medard
...
**[LG - Machine Learning](https://arxiv.org/list/cs.LG/recent)** - Tom Dieterrich, Sebastian Raschka and Luis Lamb
...
topic modeling), crowdsourcing (cs.HC), quantitative finance ([q-fin](https://arxiv.org/archive/q-fin)),
and quantitative biology ([q-bio](https://arxiv.org/archive/q-bio)). Papers discussing the foundations of
...
**[LO - Logic in Computer Science](https://arxiv.org/list/cs.LO/recent)** - Gopalan Nadathur
...
**[MS - Mathematical Software](https://arxiv.org/list/cs.MS/recent)** - Paolo Bientinesi

Roughly includes material in ACM Subject Class G.4.

**[MA - Multiagent Systems](https://arxiv.org/list/cs.MA/recent)** - Jose Vidal
...
**[MM - Multimedia](https://arxiv.org/list/cs.MM/recent)** - Kishore Ramachandran

Roughly includes material in ACM Subject Class H.5.1.

**[NI - Networking and Internet Architecture](https://arxiv.org/list/cs.NI/recent)** - Katerina Argyraki
...
**[NE - Neural and Evolutionary Computation](https://arxiv.org/list/cs.NE/recent)** - Jordan Pollack
...
**[NA - Numerical Analysis](https://arxiv.org/list/cs.NA/recent)** - Paolo Bientinesi

Roughly includes material in ACM Subject Class G.1.

**[OS - Operating Systems](https://arxiv.org/list/cs.OS/recent)** - William Waite

Roughly includes material in ACM Subject Classes D.4.1, D.4.2., D.4.3, D.4.4, D.4.5, D.4.7, and D.4.9.

**[OH - Other](https://arxiv.org/list/cs.OH/recent)** - Joe Halpern
...
**[PF - Performance](https://arxiv.org/list/cs.PF/recent)** - Leana Golubchik
...
**[PL - Programming Languages](https://arxiv.org/list/cs.PL/recent)** - Gopalan Nadathur

Covers programming language semantics, language features, programming approaches (such as object-oriented programming, functional programming, logic programming). Also includes material on compilers oriented towards programming languages; other material on compilers may be more appropriate in Architecture (AR). Roughly includes material in ACM Subject Classes D.1 and D.3.

**[RO - Robotics](https://arxiv.org/list/cs.RO/recent)** - Damien Chablat

Roughly includes material in ACM Subject Class I.2.9.

**[SI - Social and Information Networks](https://arxiv.org/list/cs.SI/recent)** - Jure Leskovec and David Gleich
...
**[SE - Software Engineering](https://arxiv.org/list/cs.SE/recent)** - Stéphane Ducasse and Nicolas Anquetil
...
**[SD - Sound](https://arxiv.org/list/cs.SD/recent)** - Michael O'Donnell
...
**[SC - Symbolic Computation](https://arxiv.org/list/cs.SC/recent)** - Rich Zippel

Roughly includes material in ACM Subject Class I.1.

**[SY - Systems and Control](https://arxiv.org/list/cs.SY/recent)** - Marco Lovera, Guodong Shi, Jan-Willem Van Wingerden, and Yuan Wang
