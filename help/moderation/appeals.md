...
The appeal is a request sent to arXiv staff. You are not communicating directly with the original moderators, and it is not appropriate to attempt to contact them directly. In general, appeals are for additional scrutiny of moderation [decisions before](help/moderation#what-policies) and [after announcement](/help/moderation#policies-after). No third-party appeal for inclusion will be considered. 
