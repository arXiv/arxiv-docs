What was New on the arXiv.org e-print archives

What was New on the [arXiv.org](/) (xxx) e-print archives
=========================================================

(Haphazard collection of messages from before Summer '94; see also from ['94-'96](94-96.html); plus a slightly less haphazard collection of [later messages](/new/).)
...
\*\*\*\*\*\*\*\*\*\* N.B.  these are "archives", not "bulletin boards" \*\*\*\*\*\*\*\*\*\*
(persons using the latter terminology will be excluded further access).
...
Date:         Mon, 07 Sep 92 18:44:53 EDT
From: Franco Jona <FRANCO@ccvm.sunysb.edu>
Subject:      comment
To: ????? <e-mail@xxx.lanl.gov>

      NONAUTOMATED RESPONSE TO IDIOTIC INSTRUCTIONS
I hope you are not a teacher, because if you are, God protect your students !
As an EXAMPLE of how to suscribe, you told me to write, in the "subject" field:
                suscribe N.D. Mozart, etc...
So when I send you a note with my full name in the subject field thus:
                suscribe Franco Jona...
I only follow your example !  So, what's the meaning of the use of fancy
adjectives, such as "scintillating" and "automated response" ?  And what's
the meaning of  <<< note that 'suscribe' is not a word >>> ?  Last time I
checked, 'suscribe' WAS a word, and I believe it still is.
   If you cannot give me (and others) clear and unambiguous instructions,
then I don't care to join whatever it is that you advertise.  I have more
important things to do than to try and decipher your boring messages.
   Scintillatingly yours,    Franco Jona
...
1)
new bulletin board: gr-qc@xxx.lanl.gov (general relativity / quantum cosmology)
...
to facilitate ftp access.  if you are not already on a unix system
connected to internet, you should stop procrastinating and get one for
yourself or for your group. (such a system will be many times more powerful
than whatever you are currently using and is available at a fraction of the
cost. future changes may not be so transparent.) 
...
there have been complaints about excessive numbers of replacements. this system
is now programmed to assign a random integer from 1 to 6 as the number of
allowed replacements for any given paper. so before you try to replace your
hastily submitted preliminary and/or untexable version, you must ask yourself
...
notice that these addresses are all distinct. an evidently \*subtle point\*:
when submitting a paper you have to send it to the correct address.
otherwise it will end up in the wrong place.   another \*subtle point\*:
do not send the same paper to more than one bulletin board.
do not send the same paper to more than one bulletin board.
a means of cross linking will soon be available. if you cannot decide where
to send your paper, rather than rail against the sluggish pace of software 
development, just pretend none of these systems exist yet and send it nowhere. 
...
please do not send comments or complaints regarding this message, 
regardless of how manifestly obvious or thoroughly objectionable you find it.
...
until then, if you cannot decide where to send, don't send anywhere.
...
outraged authors report receipt of numerous direct requests from hapless
individuals evidently trying to evade an alleged charge of .25/paper.
we sincerely regret the distasteful electronic mishap responsible for this
unfortunate rumor, and regret as well being besieged by offers to pay in
advance by check. (this is really happening, "my what times we live in")
...
1992 means something for europe and also marks the end of the free phase of the
bulletin board. users wishing to continue should set up a bank account from
which US $$ can be electronically transferred at the end of each month (group
accounts preferred). the charge is $2/month per subscriber and $.25/request
(quite inexpensive per user, but with > 700 subscribers and an average
400 requests/day adds up quite nicely thank you very much). there remains
no charge for submitting papers, except untexable papers will be assessed a
penalty (roughly equal to that for illegal parking in downtown tokyo).
...
(There's also a haphazard collection of messages from ['94-'96](94-96.html); plus a slightly less haphazard collection of [later messages](/new/).)

[www-admin@xxx.lanl.gov](mailto:www-admin@xxx.lanl.gov)
