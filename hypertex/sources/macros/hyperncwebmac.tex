...
\def\stsec{\rightskip=0pt % get out of C mode (cf. \B)
  ...
  \noindent{\let\*=\empty\bf\hyperdef\hypernoname
           {section}{\secstar}{\let\*=\lapstar\bf\secstar.}\quad}}
...
\def\lheader{\mainfont\hyperdef\hypernoname{page}{\the\pageno}%
             {\the\pageno}\eightrm\qquad\grouptitle\hfill\title\qquad
...
\def\contentsline#1#2#3#4{\ifnum#2=0 \smallbreak\fi
    \line{\consetup{#2}#1
      ...
      \let\preserve=\*\let\*=\empty
      \hyperref{}{section}{#3}{\let\*=\preserve#3}\hbox to3em{\hss
      \hyperref{}{page}{#4}{\let\*=\preserve#4}}}}
